...
class PositionwiseFeedForward(nn.Module):
    ...
    def __init__(self, d_in, d_hid, dropout=0.1): # d_in = 32, d_hid = 64 (32*2*32) N(C)HW
        super().__init__()
        self.conv_1 = nn.Conv2d(1, 1, (1, 13), stride=(1, 1), padding="same")
        self.conv_2 = nn.Conv2d(1, 1, (1, 13), stride=(1, 1), padding="same")
        self.conv_3 = nn.Conv2d(1, 1, (1, 11), stride=(1, 1), padding="same")
        self.conv_4 = nn.Conv2d(1, 1, (1, 11), stride=(1, 1), padding="same")
        self.conv_5 = nn.Conv2d(1, 1, (1, 9), stride=(1, 1), padding="same")
        self.conv_6 = nn.Conv2d(1, 1, (1, 9), stride=(1, 1), padding="same")
        self.conv_7 = nn.Conv2d(1, 1, (1, 7), stride=(1, 1), padding="same")
        self.conv_8 = nn.Conv2d(1, 1, (1, 7), stride=(1, 1), padding="same")
        self.conv_9 = nn.Conv2d(1, 1, (1, 5), stride=(1, 1), padding="same")
        self.conv_10 = nn.Conv2d(1, 1, (1, 5), stride=(1, 1), padding="same")
        self.conv_11 = nn.Conv2d(1, 1, (1, 5), stride=(1, 1), padding="same")
        self.conv_12 = nn.Conv2d(1, 1, (1, 3), stride=(1, 1), padding="same")
        self.conv_13 = nn.Conv2d(1, 1, (1, 3), stride=(1, 1), padding="same")
        # self.w_1 = nn.Linear(128, d_hid)
        # print("d_in = ", d_in)
        # print("d_hid = ", d_hid)
    ...
    def forward(self, x):
        residual = x
        # print("\nbeginning: ", x.shape) # [32, 2, 32]
        x = x[:, None, :, :] # [32, 1, 2, 32] NCHW
        ...
        x = self.conv_12(x)
        x = self.conv_13(x)
        # print("after conv_1: ", x.shape) # [32, 1, 2, 32]
        x = torch.squeeze(x, dim=1)
        # print("after sqeeze: ", x.shape) # [32, 2, 32]
            
        x = self.w_1(x) 
        # print("after w_1: ", x.shape) # [32, 2, 64]
        x = self.w_2(F.gelu(x))
        # print("after w_2:", x.shape) # [32, 2, 32]
        x = self.dropout(x)
        x += residual
